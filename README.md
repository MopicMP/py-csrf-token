...
> Py generate and validate csrf tokens

[![PyPI version](https://badge.fury.io/py/py-csrf-token.svg)](https://pypi.org/project/py-csrf-token/)
...
```bash
pip install py-csrf-token
```

## Quick Start

```python
from py_csrf_token import token

# Basic usage
result = token("your input here")
print(result)
```
...
result = token("Hello World")

# Example 2: Batch processing
from py_csrf_token import batch
